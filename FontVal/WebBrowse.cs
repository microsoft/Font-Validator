...
namespace FontVal
{
    ...
    public class WebBrowse : Form
    {
        public WebBrowse( string initUri) 
        {
            // Create the form layout. If you are using Visual Studio, 
            // you can replace this code with code generated by the 
            // designer. 
            InitializeForm();
            ...
            if ( null == initUri ||
                ...
                webBrowser1.Url = new Uri( initUri );
            }
        }
        ...
        private void propertiesToolStripMenuItem_Click( object sender, 
                                                        EventArgs e)
        {
        ...
        // The remaining code in this file provides basic form
        // initialization and includes a Main method. If you use the
        // Visual Studio designer to create your form, you can use the
        // designer generated code instead of this code, but be sure
        // to use the names shown in the variable declarations here,
        // and be sure to attach the event handlers to the associated
        // events.
...
//                Application.Run(new Form1( initUri ));
//            }
    }
    */
}